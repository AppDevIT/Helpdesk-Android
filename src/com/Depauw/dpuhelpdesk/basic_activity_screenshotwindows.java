...
public class basic_activity_screenshotwindows extends Activity {
    WebView webview;
    private String url = "http://windows.microsoft.com/en-US/windows7/Use-Snipping-Tool-to-capture-screen-shots";
    ProgressBar pd = null;
