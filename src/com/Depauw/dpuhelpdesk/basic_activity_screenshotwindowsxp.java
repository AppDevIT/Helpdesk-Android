...
public class basic_activity_screenshotwindowsxp extends Activity {
    WebView webview;
    private String url = "http://windows.microsoft.com/en-us/windows-xp/help/setup/take-a-screen-shot";
    ProgressBar pd = null;
