...
public class accounts_activity_payroll extends Activity {
	//This here helps pre-define for the entire page what each variable will contain
    WebView webview;
    private String url = "http://kb.wordpress.depauw.edu/?page_id=3240";
    ProgressBar pd = null;
  ...
  //these two are ust helpers in returning and setting the urls
